/**
 * web interface for alexa control project.
 */
#include <Arduino.h>

const char index_html[] PROGMEM = "<html><head>%REFRESHINDEXTAG%<link rel=\"icon\" type=\"image/vnd.microsoft.icon\" href=\"/favicon.ico\"><style>*{margin:0;font-family:Arial,Helvetica,sans-serif;} .active{background-color:green;} .off {color:red;} .startup{color:green;} .shutdown {color:blue;} .button{margin-bottom:10px;}</style></head>\n<body style='height:100%%;'><div style='position:relative;min-height:99%%;'><div style='background-color:lightgrey;position:absolute;width:98%%;bottom:0;text-align:center;height:1em;margin-left:1%%;'><a href=\"/log.html\">%REFRESHINDEXLINK% &nbsp; Log</a> &nbsp; | Build: %__TIMESTAMP__%</div><h1 style='position: absolute;top: 0;padding-left:10%%;'>%APPNAME%</h1><div style='padding:5em 1%% 2em 1%%;'>%STATUSBAR%<p style=\"padding-top:10%%;\">Kanal aktivieren:<div style=\"text-align: center;\">%BUTTONS%</div></p><div style=\"margin-top:50px;background-color: rgb(230,230,230);padding:5px;border-top:solid 1px;\">TV-Kanal:<button onclick=\"location.href='/channel/up';\">Channel Up</button><button onclick=\"location.href='/channel/down';\">Channel Down</button> &nbsp; %BUTTON_MAIN%<br/><p style=\"margin-top:30px;\">Aktiv:%SETCHANNEL_LINKS%</p></div></div></div></body></html>";

const char log_html[] PROGMEM = "<html><head>%REFRESHLOGTAG%<link rel=\"icon\" type=\"image/vnd.microsoft.icon\" href=\"/favicon.ico\"><style>.log{font-family:\"Consolas\",\"lucida console\",monospace;padding:5px;font-size:15px;word-break:break-all;word-wrap:break-word;color:white;background-color:#111;display:block;line-height:1.5em;margin-top:0;} .head{position:fixed;height:2em;width:95%%;background-color:lightgrey;margin:0 2%% 0 2%%;} .active{background-color:green;} .shutdown{color:blue;}</style></head>\n<body><table class=\"head\"><tr><td style = \"text-align: left;\"><a href=\"/index.html\">Back</a> &nbsp; %REFRESHLOGLINK% &nbsp; %IRRCV_BUTTON%</td><td style=\"text-align:center;\">Log - Protokoll  <span style=\"color:blue;font-weight:bold;\">%STATUS%</span><td><td style=\"text-align:right;padding-right:5px;\" title=\"%UPSINCE% / %RESET_REASON%\">Now = %SYSTIME%</td></tr></table><div style=\"padding-top:2em;\"><pre class=\"log\">%LOG0%%LOG1%</pre></div><script>if(!window.location.hash){window.scrollTo(0, document.body.scrollHeight);}</script></body></html>";
